...
public class PersonTypeServiceTest {
    ...
    @Test
    public void shouldThrowExceptionWhenAttributeTypeIsInvalid() {
        PersonType personType = new PersonType();
        RequiredAttribute attribute = mock(RequiredAttribute.class);
        AttributeType invalidType = mock(AttributeType.class);

        when(attribute.getName()).thenReturn("Height");
        when(attribute.getAttributeType()).thenReturn(invalidType);
