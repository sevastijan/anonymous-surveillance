...
public class PersonSpecification {
    ...
    public static Specification<Person> createSpecification(PersonSearchCriteriaDto personSearchCriteriaDto) {
        return (root, query, builder) -> {
            ...
            if (personSearchCriteriaDto.getNumericRanges() != null && !personSearchCriteriaDto.getNumericRanges().isEmpty()) {
                for (Map.Entry<String, Number[]> entry : personSearchCriteriaDto.getNumericRanges().entrySet()) {
